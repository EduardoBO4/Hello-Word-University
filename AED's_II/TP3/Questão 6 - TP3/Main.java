...
class PilhaFlex {
    ...
    // A maioria das questões de Pilha exigem a impressão do topo até a base,
    // ou da base ao topo enumerado (ex: [0] ..., [1] ...).
    // Mantive a sua lógica de mostrar da forma como você configurou (topo -> base).
    public void mostrar() {
        for(Celula i = topo; i != null; i = i.prox) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0; i < n; i++) {
            ...
            if(entrada.equals("I")) {
                ...
                // Adicionado o espaço entre (R) e o Nome, que faltava!
